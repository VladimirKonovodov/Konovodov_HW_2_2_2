        ...
        mBtnOk.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mBankCardChkBx.isChecked()) {
                    Toast.makeText(CheckboxActivity.this, "оплата банковской картой", Toast.LENGTH_LONG).show();
                }
                if (mMobilePhoneChkBx.isChecked()) {
                    Toast.makeText(CheckboxActivity.this, "оплата с мобильного телефона", Toast.LENGTH_LONG).show();
                }
                if (mCashAddressChkBx.isChecked()) {
                    Toast.makeText(CheckboxActivity.this, "оплата наличными по адресу", Toast.LENGTH_LONG).show();
                }
