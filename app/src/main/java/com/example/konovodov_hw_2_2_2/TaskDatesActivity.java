...
public class TaskDatesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_task_dates);
        initViews();
        ...
        mBtnOK.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (mStartDate > mEndDate) {
                    Toast.makeText(TaskDatesActivity.this, "Ошибка", Toast.LENGTH_LONG).show();
                    mChooseStartDate.setText("Дата-время старта задачи:");
                    mChooseEndDate.setText("Дата-время окончания задачи:");
                } else {
                    Toast.makeText(TaskDatesActivity.this, "старт: " + mStartDateTxt + " окончаниe: " + mEndDateTxt, Toast.LENGTH_LONG).show();
                }
            }
        });
    }
